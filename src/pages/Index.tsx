...
import { ArrowRight, Play, Sun, Wind, Phone, Sparkles, Smile } from "lucide-react";
            ...
            {features.map((feature, index) => (
              ...
              >
                <CardContent className="p-6 space-y-4">
                  ...
                  <Button variant="link" className="p-0 h-auto text-primary font-medium group-hover:gap-2 transition-all">
                    {feature.action}
